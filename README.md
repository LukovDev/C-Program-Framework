...
13. Копируем необходимые библиотеки в папку бинара:
...
14. Сохраняем новые метаданные в случае удачной сборки.
...
- Распределяет компиляцию по ядрам процессора и ждёт завершение компиляции, чтобы начать линковку.
