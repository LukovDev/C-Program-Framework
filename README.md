...
10. Обработка файлов:
   ...
   - Сортировка списка файлов по их размеру от больших к меньшим.
...
- Удаляет те объектные файлы, исходник которых удалён. Также удаляет лишние объекты, которых не должно быть (очистка от мусора). Она отслеживает платформу, конфиг сборки, версию системы сборки, файлы исходников, их зависимости и их хеш суммы. Делает рекомпиляцию (сброс сборки) в случае необходимости.
